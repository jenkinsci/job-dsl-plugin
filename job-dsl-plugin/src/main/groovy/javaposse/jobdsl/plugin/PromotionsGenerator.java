...
/**
 * Generate "promotions"-folder including the defined promotions with their config.xml's
 * Code copied from {@link ItemGroupMixIn#createProjectFromXML(String, InputStream)} and {@link AbstractItem#updateByXml(Source)}
 */
