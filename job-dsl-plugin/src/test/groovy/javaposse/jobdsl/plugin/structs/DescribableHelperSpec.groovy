...
import javaposse.jobdsl.plugin.fixtures.SubTrigger
...
class DescribableHelperSpec extends Specification {
    ...
    def 'sub class'() {
        when:
        def describableModels = DescribableHelper.findDescribableModels(TriggerContext, 'sub')
