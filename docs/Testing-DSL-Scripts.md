...
Have a look at [Jenkins Job DSL Gradle example](https://github.com/sheehan/job-dsl-gradle-example),
[Job DSL Sample](https://github.com/unguiculus/job-dsl-sample) or
[Jenkins Job DSL automation starter](https://github.com/kamilszymanski/jenkins-jobdsl-automation-starter)
for examples which could be used as a starting point.
