...
Valid values for region are `'GovCloud'`, `'us-east-1'`, `'us-west-1'`, `'us-west-2'`, `'eu-west-1'`,
`'ap-southeast-1'`, `'ap-southeast-2'`, `'ap-northeast-1'`, `'sa-east-1'` or `'cn-north-1'`. The storage class can be
