...
conditionalSteps {
    condition {
        ...
        time(String earliestHour, String earliestMinute, String latestHour, String latestMinute, boolean useBuildTime) // Run if the current (or build) time is between the given dates.
