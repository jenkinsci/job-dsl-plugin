...
## Release Notes
* 1.36 (unreleased)
 * Added support for the `filesMatch` condition from the [Run Condition Plugin](https://wiki.jenkins-ci.org/display/JENKINS/Run+Condition+Plugin) ([JENKINS-29503](https://issues.jenkins-ci.org/browse/JENKINS-29503))
