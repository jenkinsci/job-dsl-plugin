 ...
 * The enum `javaposse.jobdsl.dsl.helpers.step.condition.FileExistsCondition.BaseDir` is deprecated, see
   [Migration](Migration#migrating-to-147)
 * Enhanced support for the [Build Name Setter Plugin](https://wiki.jenkins-ci.org/display/JENKINS/Build+Name+Setter+Plugin)
   [(#857)](https://github.com/jenkinsci/job-dsl-plugin/pull/857)
* 1.46 (May 08 2016)
