...
class WrapperContext implements Context {
     ...
     * </buildWrappers>
     */
     def rbenv(String version, String[] gems, Closure rbenvClosure) {
        ...
        wrapperNodes << nodeBuilder.'ruby-proxy-object' {
            'ruby-object'('ruby-class': 'Jenkins::Plugin::Proxies::BuildWrapper', pluginid: 'rbenv') {
                ...
                object('ruby-class': 'RbenvWrapper', pluginid: 'rbenv') {
                    rbenv__root(rubySpecification, [pluginid: 'rbenv', 'ruby-class': 'String'])
                    version(version, [pluginid: 'rbenv', 'ruby-class': 'String'])
     ...
     */
    def colorizeOutput(String colorMap = 'xterm') {
