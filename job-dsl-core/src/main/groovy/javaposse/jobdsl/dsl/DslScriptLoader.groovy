...
class DslScriptLoader {
    ...
    private static CompilerConfiguration createCompilerConfiguration(JobManagement jobManagement) {
        ...
        icz.addImports('javaposse.jobdsl.dsl.views.jobfilter.FallbackType')
        icz.addImports('javaposse.jobdsl.dsl.views.jobfilter.JobType')
        icz.addImports('javaposse.jobdsl.dsl.views.jobfilter.MatchType')
        icz.addImports('javaposse.jobdsl.dsl.views.jobfilter.PermissionCheckType')
        ...
        icz.addImports('javaposse.jobdsl.dsl.views.jobfilter.ScmType')
