...
class WrapperHelperSpec extends Specification {
    ...
    def 'add rbenv-controlled override defaults'() {
        ...
        then:
        def rootObject = root.buildWrappers[0].'ruby-proxy-object'[0].'ruby-object'[0].object[0]
        rootObject.version[0].value() == '2.1.2'
        rootObject.gem__list[0].value() == ''
        rootObject.rbenv_root[0].value() == 'foo'
        rootObject.ruby__build__repository[0].value() == 'foobar'
        rootObject.rbenv__revision[0].value() == '2.0'
        rootObject.rbenv__repository[0].value() == 'barfoo'
        rootObject.ruby__build__revision[0].value() == '1.0'
        rootObject.ignore__local__version[0].'@ruby-class' == 'TrueClass'
    ...
    def 'add rbenv-controlled ruby version and gems'() {
        ...
        def rootObject = root.buildWrappers[0].'ruby-proxy-object'[0].'ruby-object'[0].object[0]
        rootObject.version[0].value() == '2.1.2'
        rootObject.gem__list[0].value() == 'bundler,rake,'
    }
